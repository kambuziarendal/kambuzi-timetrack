...
manifest="$output/kambuzi-timeforing-$version-$commit-release-manifest.txt"
{
  ...
  echo "signing=GitHub Artifact Attestations are generated by hosted CI for source, SBOM, manifest and offline image archives; verify with gh attestation verify."
} > "$manifest"
